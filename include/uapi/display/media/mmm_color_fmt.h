 ...
 * Interlaced: width
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_Y_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: width
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_UV_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
	unsigned int alignment, stride = 0;
 ...
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_Y_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
 ...
 * Interlaced: (height+1)>>1
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_UV_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
	unsigned int alignment, sclines = 0;
 ...
 * Interlaced: width
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_Y_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: (height+1)>>1
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_Y_META_SCANLINES(
 ...
 * Interlaced: width
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_UV_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: (height+1)>>1
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_UV_META_SCANLINES(
		unsigned int color_fmt,	unsigned int height)
{
...
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_RGB_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
...
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_RGB_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
...
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_RGB_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
...
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_RGB_META_SCANLINES(
		unsigned int color_fmt,	unsigned int height)
{
 ...
 * Interlaced: height
 */
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_BUFFER_SIZE(unsigned int color_fmt,
...
unsigned int __attribute__ ((weak)) MMM_COLOR_FMT_BUFFER_SIZE_USED(
